...
<body onload="document.new_event.eventTitle.focus();">
    ...
    <form name='new_event' onSubmit="formValidation(this); return false;" action = "${pageContext.servletContext.contextPath}/event" method = "POST">
        <ul>
            ...
            <li><input type="datetime" name="dateandtime" size="12" /></li>
